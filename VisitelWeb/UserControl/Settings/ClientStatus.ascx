<%@ Control Language="vb" CodeBehind="~/UserControl/Settings/ClientStatus.ascx.vb"
    Inherits="VisitelWeb.Visitel.UserControl.Settings.ClientStatusSetting" %>
<div>
    <div id="Div3" class="SectionDiv-header">
        <asp:Label ID="LabelClientStatusInformationEntry" runat="server"></asp:Label>
    </div>
    <div class="newRow">
    </div>
    <asp:UpdatePanel ID="UpdatePanelClientStatusInformationEntry" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <div class="newRow">
    ...
    <div id="Div2" class="SectionDiv-header">
        <asp:Label ID="LabelSearchClientStatusInfo" runat="server"></asp:Label>
    </div>
    <div class="newRow">
    </div>
    <div class="newRow">
    ...
    <div id="tabs-System">
        <div id="Div20" class="SectionDiv" runat="server">
            <div id="Div1" class="SectionDiv-header">
                <asp:Label ID="LabelClientStatusInformationList" runat="server"></asp:Label>
            </div>
            <asp:UpdatePanel ID="UpdatePanelClientStatusInformation" runat="server" UpdateMode="Always">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="GridViewClientStatusInformation" runat="server" Width="100%">
                        <Columns>
                ...
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="GridViewClientStatusInformation" />
                </Triggers>
            </asp:UpdatePanel>
            <br />
            <br />
