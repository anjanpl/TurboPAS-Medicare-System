<%@ Control Language="vb" CodeBehind="~/UserControl/Settings/DischargeReason.ascx.vb"
    Inherits="VisitelWeb.Visitel.UserControl.Settings.DischargeReasonSetting" %>
<div>
    <div id="Div3" class="SectionDiv-header">
        <asp:Label ID="LabelDischargeReasonInformationEntry" runat="server"></asp:Label>
    </div>
    <div class="newRow">
    </div>
    <asp:UpdatePanel ID="UpdatePanelDischargeReasonInformationEntry" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <div class="newRow">
    ...
    <div id="Div2" class="SectionDiv-header">
        <asp:Label ID="LabelSearchDischargeReasonInfo" runat="server"></asp:Label>
    </div>
    <div class="newRow">
    </div>
    <div class="newRow">
        ...
        <div class="AutoColumn">
            <asp:Label ID="LabelSearchByStatus" runat="server"></asp:Label>
        </div>
        <div class="AutoColumn">
            <asp:DropDownList ID="DropDownListSearchByStatus" runat="server">
            </asp:DropDownList>
        </div>
    ...
    <div id="tabs-System">
        <div id="Div20" class="SectionDiv" runat="server">
            <div id="Div1" class="SectionDiv-header">
                <asp:Label ID="LabelDischargeReasonInformationList" runat="server"></asp:Label>
            </div>
            <asp:UpdatePanel ID="UpdatePanelDischargeReasonInformation" runat="server" UpdateMode="Always">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="GridViewDischargeReasonInformation" runat="server" Width="100%">
                        <Columns>
                ...
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="GridViewDischargeReasonInformation" />
                </Triggers>
            </asp:UpdatePanel>
            <br />
            <br />
